...
import type { TFormiFieldAny, TOutputBase } from './FormiField.types';
...
export function FormiStore(
  ...
  type GetInputResult = { resolved: false; input: null } | { resolved: true; input: TOutputBase<TFormiFieldTree> };
